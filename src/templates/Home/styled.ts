...
import * as HeadingStyles from 'components/Heading/styled';
import * as GameCardSliderStyles from 'components/GameCardSlider/styled';
import * as HighlightStyles from 'components/Highlight/styled';
